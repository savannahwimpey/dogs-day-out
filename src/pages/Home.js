    ...
    return (
        <>
            ...
            <article>
                ...
                <br></br>
                <p> On our <strong>Explore Page</strong>, you can browse user-rated establishments, leave comments, and bookmark your favorites to visit later. If you’re looking for something specific, our <strong>Search Page</strong> lets you check if a location is dog-friendly by name. And if you’ve discovered a great spot that isn’t listed yet, you can add it through the <strong>Post Page</strong> to share with the community.</p>
                <br></br>
